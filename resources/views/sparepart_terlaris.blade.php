            ...
            <table style="margin:25px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="mytable tac">Nama Barang</td>
                        <td class="mytable tac">Tipe Barang</td>
                        <td class="mytable tac">Jumlah Penjualan</td>
                    </tr>
                    {{$i=0}}
                    ...
                    <tr>
                        ...
                        <td class="mytable">{{$data->NamaBarang}}</td>
                        <td class="mytable">{{$data->TipeBarang}}</td>
                        <td class="mytable tar">{{$data->JumlahPenjualan}}</td>
                    </tr>
                    @endforeach
                    <tr class="tar">
