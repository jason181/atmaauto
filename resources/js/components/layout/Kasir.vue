<template>
   <div class="content" id="homeLayout">
                        ...
                        <tr v-bind:key="transaksi['Id_Transaksi']" v-for="transaksi in filteredtransaksi">
                            ...
                            <td class="text-center">
                                <p data-placement="top" data-toggle="tooltip" title="Detail">
                                    <button @click="transaksihandler(transaksi)"  
                            ...
                            <td class="text-center">
                                <p data-placement="top" data-toggle="tooltip" title="SPK">
                                    <button @click="transaksihandler(transaksi)" 
                                    class="btn btn-success" data-title="Pembayaran" :disabled="transaksi.Status !== 2"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer mt-3" >
                            ...
                            data-dismiss="modal" @click="updatepenjualan(Transaksi.Id_Transaksi)">Simpan Perubahan</button>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <!-- END OF EDIT TRANSAKSI PENJUALAN -->
        ...
        <div class="modal fade" id="Pembayaran" tabindex="-1" role="dialog" aria-labelledby="Pembayaran" 
        aria-hidden="true">
            <div class="modal-dialog" style="max-width:750px;">
                <div class="modal-content" style="width:750px;">
                    <div class="modal-header">
                        <h4 class="modal-title mx-auto" id="Heading">Pembayaran</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" aria-label="Close" 
                        style="margin-left: -30px;">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2" style="text-align:right">
                                <p>
                                    {{formatPrice(this.pembayaran.Subtotal)}}
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-2" style="text-align:right">
                                <p>
                                    {{formatPrice(this.pembayaran.Diskon)}}
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-2" style="text-align:right">
                                <p>
                                    {{formatPrice(this.pembayaran.Total)}}
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p data-placement="top" data-toggle="tooltip" title="Nota Lunas">
                                    <button @click="updatepembayaran(pembayaran.Id_Transaksi),cetaknotalunas(pembayaran.Id_Transaksi)" 
                                    class="btn btn-success w-100" data-title="Cetak_Nota_Lunas"
    ...
    methods:{
        ...
        async updatepenjualan (id) {
            try {
                ...
                await penjualanController.updatepenjualan(payload)
                this.getallpenjualan()
                this.getalldetailpenjualan()
                this.getalldetailjasa()
                this.refresh()
        ...
        async updatepembayaran(id){
            try {
                const payload = {
                    Id_Pegawai           : this.Id_Pegawai
                }
                await penjualanController.updatepembayaran(payload,id)
                this.getallpenjualan()
            } catch (err){
                console.log(err)
            }
        ...
        transaksihandler(transaksi)
        {
            this.pembayaran = transaksi
    ...
    computed:{
        ...
        filtereddetail:function(){
            return this.detailpenjualandata.filter((detailpenjualan)=>{
                return detailpenjualan.Id_Transaksi == this.pembayaran.Id_Transaksi;
            });
            return this.detailpenjualandata.filter((detailpenjualan)=>{
        ...
        filtereddetailjasa:function(){
            return this.detailjasadata.filter((detailjasa)=>{
                return detailjasa.Id_Transaksi == this.pembayaran.Id_Transaksi;
            });
        },
        nameErrors () {
            const errors = []
